...
<head>
	...
	<title>Nutrique - Dónde Comprar Nutrique</title>

	<?php include 'includes/includes.php';?>
	
	<script type="text/javascript" src="js/wow.min.js"></script>
</head>
<body id="dondecomprar">
<div class=" internal principales store general">
	...
	<div class="section page1" id="section0">
		...
		<div class="page_container" style="height:100%;">
			<div class="contacto col-12  ">
				<h1 class="col-12 wow animated fadeInUp offset-md-3">Dónde Comprar Nutrique</h1>
				<section class="search" data-aos="fade-in">
					<form >
						  <div class="form-field col-12 col-sm-12 wow animated fadeInUp" data-wow-delay="200ms">
...
<!--
						  <div class="form-field col-12 col-sm-4 wow animated fadeInUp" data-wow-delay="200ms">
							<input type="search" id="buscar-postal" name="search-postal" placeholder="O buscá por código postal">
							<button id="buscar-posta-search" type="submit" src="" >IR</button>
...
<script type="text/javascript">
	...
	new WOW().init();
		...
		jQuery(function($) {
			var ajaxurl = "/buscador-tiendas-ajax.php";
			var templateurl = "https://www.vitalcan.cl/wp-content/themes/vitalcan";
			...
			function parse_store_results(stores, nearer = false) {
				...
				var cats = stores[i].cats;
					$('.stores-items').append('<li><div class="info"><h3 class="semiBold nombre">'+stores[i].title+'</h3><p class="medium direccion">'+stores[i].direccion+'</p>	<p class="medium telefono">'+stores[i].telefono+'</p></div></li>');
            ...
            var svg = template.replace('{{ color }}', 'black');
 ...
 function codePostal2() {
	 ...
	 $.ajax({
			...
			data : {
				'action' : 'getNearStores',
				'categories' : get_selected_categories(),
				'codigopostal': document.getElementById('buscar-postal').value
...
function getBoundsZoomLevel(bounds, mapDim) {
 ...
 <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtAJWp_7kdApP1yzNFsIfMkQoFyadDUqE&callback&callback=initMap&libraries=places"
